using Practice.MvvmLight.Utility.Validation;
using System;
...
namespace Practice.MvvmLight.Model.Command
{
    [MetadataType(typeof(ValidatableUserInfoModel))]
    public class ValidatableUserInfoModel : ValidatableObject
    {
        #region 属性 
